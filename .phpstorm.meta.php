...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\windows\programs\xamp\htdocs\king-store\public\storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.D:\\windows\\programs\\xamp\\htdocs\\king-store\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'hashing.rehash_on_login','view.paths','view.compiled','debugbar.enabled','debugbar.hide_empty_tabs',
...
'signed','throttle','verified','roleManger',);
...
'livewire.preview-file','dashboard','vendor.dashboard',
'profile','admin.dashboard','admin.setting','admin.manage.user','admin.manage.store',
'admin.order.history','admin.cart.history','admin.category.create','admin.category.manage','admin.subcategory.create',
'admin.subcategory.manage','admin.product.manage','admin.product.review.manage','admin.productattribute.create','admin.productattribute.manage',
'admin.discount.create','admin.discount.manage','register','login','password.request',
'password.reset','verification.notice','verification.verify','password.confirm','storage.local',);
        registerArgumentsSet('views', 
'admin.admin','admin.cart.history','admin.category.create','admin.category.manage','admin.discount.create',
'admin.discount.manage','admin.layouts.layout','admin.manage.store','admin.manage.user','admin.order.history',
'admin.payment.create','admin.payment.manage','admin.product.manage','admin.product.manage_product_review','admin.product_attribute.create',
'admin.product_attribute.manage','admin.setting','admin.subcategory.create','admin.subcategory.manage','components.action-message',
...
'layouts.guest','livewire.layout.navigation','livewire.pages.auth.confirm-password','livewire.pages.auth.forgot-password','livewire.pages.auth.login',
'livewire.pages.auth.register','livewire.pages.auth.reset-password','livewire.pages.auth.verify-email','livewire.profile.delete-user-form','livewire.profile.update-password-form',
'livewire.profile.update-profile-information-form','livewire.welcome.navigation','profile','vendor','volt-livewire::layout.navigation',
